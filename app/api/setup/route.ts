...
export async function POST() {
  try {
    ...
    // Create indexes
    await sql`CREATE INDEX IF NOT EXISTS idx_datasets_owner ON datasets(owner_wallet)`
    await sql`CREATE INDEX IF NOT EXISTS idx_datasets_category ON datasets(category)`
    await sql`CREATE INDEX IF NOT EXISTS idx_datasets_status ON datasets(status)`
    await sql`CREATE INDEX IF NOT EXISTS idx_datasets_story_ip ON datasets(story_ip_id)`
    await sql`CREATE INDEX IF NOT EXISTS idx_datasets_nft ON datasets(nft_contract_address, nft_token_id)`
    await sql`CREATE INDEX IF NOT EXISTS idx_ai_models_owner ON ai_models(owner_wallet)`
    await sql`CREATE INDEX IF NOT EXISTS idx_ai_models_category ON ai_models(category)`
    await sql`CREATE INDEX IF NOT EXISTS idx_ai_models_status ON ai_models(status)`
    await sql`CREATE INDEX IF NOT EXISTS idx_models_story_ip ON ai_models(story_ip_id)`
    await sql`CREATE INDEX IF NOT EXISTS idx_models_nft ON ai_models(nft_contract_address, nft_token_id)`
    await sql`CREATE INDEX IF NOT EXISTS idx_transactions_buyer ON transactions(buyer_wallet)`
    await sql`CREATE INDEX IF NOT EXISTS idx_transactions_seller ON transactions(seller_wallet)`
    await sql`CREATE INDEX IF NOT EXISTS idx_reviews_item ON reviews(item_id, item_type)`
    await sql`CREATE INDEX IF NOT EXISTS idx_favorites_user ON favorites(user_wallet)`
